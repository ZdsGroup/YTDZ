 ...
 *     });
 */
Ext.define('yt.plugin.date.DateTimePicker', {
    extend: 'Ext.Component',
    alias: 'widget.datetimepicker',
    alternateClassName: 'yt.DateTimePicker',
    requires: [
        'Ext.XTemplate',
        'Ext.button.Button',
        'Ext.button.Split',
    ...
    renderTpl: [
        ...
        '<div id="{id}-footerEl" role="presentation" style="background-color:#ffffff;border-top:0px solid #99bce8;margin: 3px;">{%this.renderHour(values, out)%}{%this.renderMinute(values, out)%}{%this.renderSecond(values, out)%}<center>{%this.renderOkQueDingBtn(values, out)%}&nbsp;&nbsp;{%this.renderTodayBtn(values, out)%}</center></div>',
        '</tpl>',
        ...
        '</div>',
        {
            ...
            renderMinute: function (values, out) {
                out.push('<font  style="float : left;font-weight:bold;margin: 5px;">&nbsp:&nbsp&nbsp</font>');
